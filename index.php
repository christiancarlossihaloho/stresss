...
<head>
    ...
    <link rel="stylesheet" href="fontawesome-free-6.5.1-web (1)/fontawesome-free-6.5.1-web/css/all.min.css">
    <link rel="stylesheet" href="style.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <link rel="stylesheet" href="">
    <script src="fontawesome-free-6.5.1-web (1)/fontawesome-free-6.5.1-web/js/all.min.js" crossorigin="anonymous"></script>
    ...
    <div class="container mt-5" id="Content-contact">
        ...
        <div class="main row justify-content-center">
            <form action="" id="student-form" class="row justify-content-center mb-4" autocomplete="off">
                ...
                <div class="input-group coll-10 mb-3">
                    <input type="text" class="form-control" id="lastName" placeholder="Eneter last Name " name="name"   onkeyup="validateName1()">
